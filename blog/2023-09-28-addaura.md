...
We are going to describe how to go from a minimal standard installation to a complete remasterable system using [addaura](https://github.com/pieroproietti/addaura).

This procedure work on Arch rolling, Debian (buster, bulleye, bookworm), Devuan (chimaera and daedalus) and Ubuntu (bionic, focal and jammy).
...
Among the packages I added: `git`, `lsb-release`, others packages will be installed later by `addaur`.
