...
* Installing package eggs
  * [deb packages](./eggs_install-deb.html)
  * [npm packages](./eggs_install-npm.html)
* [Install eggs prerequisites](./eggs_prerequisites.html)

* [Producing a new ISO](./eggs_produce.html)

* [Updating eggs](./eggs_update.html)

![gettings help](https://github.com/pieroproietti/penguins-eggs/blob/master/documents/terminal-lessons/eggs_help.gif?raw=true)
