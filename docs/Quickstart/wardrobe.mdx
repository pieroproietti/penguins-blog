...
Allestire un sistema partendo da una base minimale (*naked*) garantisce un sistema finale leggero, riproducibile e perfettamente documentato nelle ricette YAML. Per approfondire tutte le funzionalità, consulta la [Guida Completa di Penguins' Wardrobe e Tailor](../Tutorial/wardrobe-users-guide).
:::